...
public class FriendVisualization {
	 ...
	 * @return
	 */
	public static final native JavaScriptObject createGraph(final String json, final FriendhipBrowser parent) /*-{
		var content = JSON.parse(json);
		...
		var ht = new $wnd.$jit.Hypertree({
		    ...
		    onCreateLabel: function(domElement, node){
		        ...
		        domElement.onclick = function () {
					parent.@com.cis550.photozee.client.FriendhipBrowser::drawNodeAndNeighbors(I)(node.id);drawNodeAndNeighbors(node.id);
	  ...
	  if (xml.hasChildNodes()) {
	    for(var i = 0; i < xml.childNodes.length; i++) {
	      ...
	      if (typeof(obj[nodeName]) == "undefined") {
	        obj[nodeName] = @edu.upenn.cis.cis550.hw4.client.FriendVisualization::xmlToJson(Lcom/google/gwt/core/client/JavaScriptObject;)(item);
	      } else {
	        ...
	        obj[nodeName].push(@edu.upenn.cis.cis550.hw4.client.FriendVisualization::xmlToJson(Lcom/google/gwt/core/client/JavaScriptObject;)(item));
	      }
	    }
	  }
	  return obj;
